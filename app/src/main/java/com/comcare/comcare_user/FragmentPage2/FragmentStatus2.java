 ...
 */
public class FragmentStatus2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_fragment_status2, container, false);
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot itemSnap : dataSnapshot.getChildren()) {
                    ...
                    if (firebaseDatabase.getUid().toString().equals(mid) && status.equals("4")){
